...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action'])) {
        if ($_POST['action'] === 'update_settings') {
            $notification_types = ['class_reminder', 'event_reminder', 'course_announcement'];
            ...
            initializeUserNotificationSettings($conn, $user_id, 'lecturer');
...
// Define notification types for lecturers
$notification_types = [
